  ...
  return (
    <div style={{ background: "#fff", borderRadius: "12px", padding: "14px", marginTop: "10px", boxShadow: "0 1px 4px rgba(0,0,0,0.06)" }}>
      <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "10px" }}>
        ...
        <span style={{ fontSize: "13px", color: "#5A6A7A" }}>南山区科技园</span>
      </div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
        ...
        <span style={{ fontSize: "13px", color: "#1F2D3D", fontWeight: 500 }}>太湖东岸钓点</span>
      </div>
      <div style={{ marginTop: "12px", paddingTop: "12px", borderTop: "1px solid #F0F2F5", display: "flex", justifyContent: "space-between" }}>
        ...
        <span style={{ fontSize: "13px", color: "#1F2D3D", fontWeight: 500 }}>05月21日 06:00-13:00</span>
      </div>
    </div>
  );
}
  ...
  return (
    <div style={{ background: "#fff", borderRadius: "12px", padding: "14px", boxShadow: "0 1px 4px rgba(0,0,0,0.06)" }}>
      <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
        <img src={PASSENGER_AVATAR} alt="乘客头像" style={{ width: "56px", height: "56px", borderRadius: "50%", objectFit: "cover" }} />
        <div style={{ flex: 1 }}>
          <div style={{ fontSize: "16px", fontWeight: 600, color: "#1F2D3D", marginBottom: "4px" }}>新手小明</div>
          <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
            <svg width="12" height="12" viewBox="0 0 24 24" fill="#FFB800">
              <path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z" />
            </svg>
            <span style={{ fontSize: "13px", color: "#1F2D3D", fontWeight: 500 }}>4.6</span>
            <span style={{ fontSize: "12px", color: "#A0AAB8" }}>· 拼车 5 次</span>
          </div>
        </div>
    ...
    <div style={{ background: "#fff", borderRadius: "12px", padding: "14px", boxShadow: "0 1px 4px rgba(0,0,0,0.06)" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
        <div style={{ display: "flex", justifyContent: "space-between" }}>
          <span style={{ fontSize: "13px", color: "#5A6A7A" }}>出行人数</span>
          <span style={{ fontSize: "13px", color: "#1F2D3D" }}>1人</span>
        </div>
        <div style={{ display: "flex", justifyContent: "space-between" }}>
          <span style={{ fontSize: "13px", color: "#5A6A7A" }}>装备类型</span>
          <span style={{ fontSize: "12px", background: "#E6F7F3", color: "#00B38A", padding: "2px 8px", borderRadius: "4px" }}>轻装</span>
        </div>
        <div style={{ display: "flex", justifyContent: "space-between" }}>
          <span style={{ fontSize: "13px", color: "#5A6A7A" }}>备注</span>
          <span style={{ fontSize: "12px", color: "#A0AAB8" }}>无</span>
        </div>
      </div>
    </div>
  );
    ...
    <PageContainer>
      <div style={{ width: '100%', maxWidth: 402, height: '100%', background: '#F0F3F6', position: 'relative', display: 'flex', flexDirection: 'column', overflow: 'hidden', flexShrink: 0 }}>
        ...
        <div style={{ flexShrink: 0, height: "52px", background: "white", display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 16px", boxShadow: "0 0.5px 0 rgba(0,0,0,0.10)" }}>
          ...
          <span style={{ fontSize: "17px", color: "#1F2D3D", fontWeight: 600, letterSpacing: "0.1px" }}>乘客详情</span>
